...
public class KeyboardActionsAdapter extends SuperBaseAdapter<ItemInsertActionBinding> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        binding.ibInsertAb.setOnClickListener(v -> {
            ...
            keyboardActionDialog.setOnDismissListener(dialog -> {
        ...
        binding.ibActionDelete.setOnClickListener(v -> {
            if (actions != null){
        ...
        if (isKeyboardSet){
            if (position == 0){
                binding.tvInsertStep.setText(context.getString(R.string.default_placeholder));
            }else {
                binding.tvInsertStep.setText(context.getString(R.string.action_step_placeholder_no_number) + position);
            }
