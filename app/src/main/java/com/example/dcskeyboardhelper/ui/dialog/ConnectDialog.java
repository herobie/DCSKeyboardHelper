...
public class ConnectDialog extends BaseDialogFragment<DialogConnectionBinding, MainViewModel> {
    ...
    protected void initParams() {
        binding.cbDefaultConfig.setOnCheckedChangeListener((buttonView, isChecked) -> {
        ...
        binding.btnConnectCancel.setOnClickListener(v -> dismiss());

        binding.btnConnectConfirm.setOnClickListener(v -> {
